...
from .serializers import ProductSerializers, CategorySerializer, CartSerializer, CartItemSerializer
...
def create_order(request):
    try:
        ...
        return Response({'message':'Order Created Sucessfully','order_id':order.id})
